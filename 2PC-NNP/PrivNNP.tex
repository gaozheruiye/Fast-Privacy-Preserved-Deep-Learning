...
\section{Two-party Secure Computation for Basic Operations}
    ...
    Our security proof follows the ideal-world/real-world paradigm \cite{SecurityProof}.
    ...
    Following the same idea, Security against $\mathcal{P}_{0}$ can also be proved.
