...
\section{Introduction}
    ...
    \begin{itemize}
        ...
        which does not require the asymmetric cryptographic operations or the bit-level operations
        ...
        We theoretically prove that our system satisfy the definition of the
