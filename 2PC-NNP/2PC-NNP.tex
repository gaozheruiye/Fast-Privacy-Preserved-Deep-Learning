...
\section{Introduction}
    ...
    while this work mainly focus on the prediction phase.
...
\section{Preliminaries}
    ...
    Moreover, we use capital letter like $A$ to denote matrix and $\overrightarrow{\mathbf{v}}$ to denote
    vector $\overrightarrow{\mathbf{v}}=(v_{0},v_{1},...,v_{n-1})$.
